        ...
        >
          ...
          <div className="relative p-5 md:p-6 rounded-[1.4rem] bg-indigo-600 text-white flex items-center justify-between shadow-xl shadow-indigo-600/20">
            <div className="flex flex-col items-start text-left">
              <span className="text-xl md:text-2xl font-outfit font-black uppercase">Architect</span>
              <span className="text-xs opacity-70 mt-1 font-medium">Design your own matrixes</span>
            </div>
